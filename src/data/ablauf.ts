...
export const ablaufSchritte: Schritt[] = [
  ...
  },
  {
    ...
    text: 'Haare wachsen in Zyklen, deshalb sind mehrere Sitzungen im Abstand von einigen Wochen nötig. Je nach Körperregion sind das in der Regel vier bis acht Termine, bis sichtbar weniger nachwächst.',
  },
];
